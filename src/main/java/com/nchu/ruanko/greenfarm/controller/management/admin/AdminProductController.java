...
public class AdminProductController {
    ...
    public ModelAndView adminProductDownPage(@RequestParam(name = "page", defaultValue = "1") int pageNum, @RequestParam(name = "size", defaultValue = "5") int pageSize) {
        ModelAndView modelAndView = new ModelAndView();
    ...
    public ModelAndView adminProductPage(@RequestParam(name = "page", defaultValue = "1") int pageNum, @RequestParam(name = "size", defaultValue = "5") int pageSize) {
        ModelAndView modelAndView = new ModelAndView();
